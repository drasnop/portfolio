...
<div class='row'>
  <div class='offset-sm-1 col-sm-4'>
    ...
    <link-button text='About' to='/about'></link-button>
  </div>

  <div class='offset-sm-2 col-sm-4'>
    <img src='/img/antoine.jpg' class='img-fluid'>
  </div>
</div>

<div class='row blue-section'>
  <div class='offset-sm-1 col-sm-3'>
    <img src='/img/xodo-android.png' class='img-fluid'>
  </div>
...
<div class='row'>
  ...
  <div class='offset-sm-2 col-sm-4'>
    <img src='/img/paperquest.png' class='img-fluid' />
  </div>
</div>

<div class='row blue-section'>
  <div class='offset-sm-1 col-sm-4'>
    <img src='/img/twistAndPulse.png' class='img-fluid'>
  </div>
  <div class='offset-sm-2 col-sm-4'>
    <h1>Twist & Pulse</h1>
